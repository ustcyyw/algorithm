/**
 * @Time : 2025/3/13-9:54 AM
 * @Author : yyw@ustc
 * @E-mail : yang0@mail.ustc.edu.cn
 * @Github : https://github.com/ustcyyw
 * @desc : CF145C 2100 动态规划 数学 组合数学
 */
 /*
  * 关键在于 幸运数字数量有限 只有1000个左右
  * 将序列拆分为 幸运数字部分和非幸运数字部分
  * 假设幸运数字的个数cnt确定了，计算cnt个幸运数字的子序列 可以动态规划
  * dp[i][j]：截止第i种幸运数字 序列长度为j 的子序列个数
  * 那么非幸运数字的个数就是 k - cnt，从所有非幸运数字中取，组合数
  */
#include<bits/stdc++.h>
using namespace std;
